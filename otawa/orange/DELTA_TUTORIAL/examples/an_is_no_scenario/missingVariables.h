...
static flag lv_var_acin ;			//from scenario
static flag lv_req_heat;				//from an_is_data
static u8 tam ;						//from scenario 22 
static u8 c_tam_n_sp_heat ;			//from scenario 0x33
static u8 c_tam_hys ;				//from scenario 0x07
...
static flag lv_var_ars ;				//from scenario
static u8 vs ;						//from scenario
static u8 c_vs_min_n_sp_is_ars ;		//from scenario
...
static u8 c_vs_max_n_sp_cs ;		//from scenario 0x0a
static u8 c_vs_hys_n_sp_cs ;			//from scenario 0x06
static flag lv_is ;					//from scenario ON in idle mode
static flag lc_is_n_sp_cs_dis;			//from an_is_data
static flag lv_cs ;					//from scenario
static flag t_ast ;					//from scenario
static flag lv_var_amt;					//from an_is_data
static flag lv_pste_disable ;		//from scenario
...
static flag lv_n_sp_is_lih_act ;		//from scenario
static flag lv_dri;						//from an_is_data
static flag lv_act_sa_eol ;			//from scenario
static u16 c_n_sp_is_sa_eol;			//from scenario
static flag lv_act_n_sp_is_ext_adj ;	//from scenario
static u16 n_sp_is_ext_adj;				//???
static flag lv_act_n_sp_is_bas_ext_adj ;	//Missing information in scenario, supposed to be "OFF"
...
static flag lv_st_end ;				//from scenario
