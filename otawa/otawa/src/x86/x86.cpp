 ...
 */
Identifier<bool> VLE_ENABLED("otawa::x86::VLE_ENABLED", false);
 ...
 * @li @ref otawa::Inst
 */
Identifier<prediction_t> STATIC_PREDICTION("otawa::x86::STATIC_PREDICTION", PRED_NONE);
 ...
 */
Identifier<void *> GLISS2_DECODER("otawa::x86::GLISS2_DECODER", 0);
 ...
 */
Feature<NoProcessor> INFO_FEATURE("otawa::x86::INFO_FEATURE");
...
public:
	...
	: Inst(process, kind, addr), _target(0), isTargetDone(false) {
		...
		if(pred != ppc::PRED_NONE)
			x86::STATIC_PREDICTION(this) = pred;
 ...
 */
const Platform::Identification Platform::ID("x86-elf-");
...
bool Platform::accept(const Identification& id) {
	return id.abi() == "elf" && id.architecture() == "x86";
}
...
:	otawa::Process(manager, props),
	...
	map(0),
	_gelFile(0),
	vle_enabled(otawa::x86::VLE_ENABLED(props))
{
...
#	endif
	...
	provide(otawa::x86::INFO_FEATURE);
	x86::GLISS2_DECODER(this) = _ppcDecoder;
}
...
// Platform definition
static hard::Platform::Identification PFID("x86-*-*");
 ...
 */
Loader::Loader(void)
: otawa::Loader("x86", Version(1, 0, 0), OTAWA_LOADER_VERSION, ppc_aliases) {
}
...
public:
	Plugin(): ProcessorPlugin("otawa::x86", Version(1, 0, 0), OTAWA_PROC_VERSION) { }
...
otawa::x86::Plugin otawa_x86;
ELM_PLUGIN(otawa_x86, OTAWA_PROC_HOOK);
